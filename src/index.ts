...
function printHelp(): void {
  process.stdout.write(
    [
      ...
      '  --launch              Launch a browser if none is found (otherwise auto-launch is the fallback)',
      '  --no-auto-launch      Fail instead of starting a managed browser when none is found',
      '  --headless            Headless mode (only with --launch or auto-launch)',
      ...
      'running profiles → port sweep :9222-:9245. Only then, unless --no-auto-launch,',
      'does Blinkwire start a managed Chrome on a verified-free port.',
      '',
